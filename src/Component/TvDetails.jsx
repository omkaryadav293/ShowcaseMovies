...
const TvDetails = () => {
  document.title = "Showcase | TvDetails"
 ...
 return info ? (
    <div>
      <div className="h-[172vh] w-full relative  ">
        ...
        <div className="flex gap-5 w-full h-80vh py-10 px-24 text-white">
          ...
          <div className="right w-[70vw] ">
            ...
            <div className="font-regular text-lg mt-2">
              <span>{info.detail.first_air_date} (IN) &nbsp; &nbsp;</span>
              <span>
        ...
        <div className="bottom px-20 text-white ">
            <h1 className="text-xl font-semibold px-5 pb-2" >Seasons</h1>
            <HorizontalCards data={info.detail.seasons.length>0 && info.detail.seasons 
            }/>
          </div>
          <div className="bottom px-20 text-white ">
            <h1 className="text-xl font-semibold px-5 pb-2" >Reccomendations</h1>
            <HorizontalCards title={"tv"} data={info.recommendations.length>0? info.recommendations : info.similar
            }/>
          </div>
          <Outlet/>
      </div>
